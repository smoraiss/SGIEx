...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $controller = new ChamadoController($chamados, $usuario,$db);
...
if ($rota === 'usuario') {
    ...
    $chamado = $protocolo !== ''
        ? $chamados->porProtocolo($protocolo)
        : null;
    ...
    $usuarioAtual = $usuario->buscar([
        'nome_guerra' => $chamado['nome_guerra'],
        'posto_graduacao' => $chamado['posto_graduacao'],
        'secao' => $chamado['secao']
    ]);
